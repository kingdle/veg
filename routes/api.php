...
Route::group(['prefix' => '/v1', 'middleware' => 'cors'], function () {
    ...
    Route::post('/shop/titleUpdate','ShopsController@titleUpdate')->middleware('auth:api');
    //dynamics动态查询
    ...
    Route::post('/order/shopStore', 'OrdersController@shopStore')->middleware('auth:api');
    Route::post('/order/shopUpdate', 'OrdersController@shopUpdate')->middleware('auth:api');
    ...
    Route::post('/order/orderList', 'OrdersController@orderList')->middleware('auth:api');
